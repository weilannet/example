  ...
  function ionSlider($ionicModal,ionGalleryData,$ionicPlatform,$timeout,$ionicScrollDelegate){
    ...
    function controller($scope){
      ...
      $scope.showImage = function(row,col) {
        ...
        var galleryLength = this.ionGalleryRow;//ionGalleryData.getGalleryLength();
      ...
      $scope.slideChanged = function(currentSlideIndex) {
        ...
        var galleryLength = this.ionGalleryRow;
        var imageToLoad;
    ...
    function link(scope, element, attrs) {
      ...
      scope.loadModal = function(){
        $ionicModal.fromTemplateUrl('slider.tpl.html', {
          scope: scope,
          animation: 'fade-in'
        }).then(function(modal) {
          _modal = modal;
